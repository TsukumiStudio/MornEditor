...
namespace MornEditor
{
    public static class MornEditorUtil
    {
        ...
        {
            internal static void DrawProperty(Object target, SerializedProperty property, HashSet<object> processingAttributes)
            {
        ...
        internal static class AttributeProcessor
        {
            ...
            internal static bool EvaluateConditions(string[] propertyNames, SerializedProperty property, bool requireAll)
            {
